...
const EXPORTA = [
  ...
  "doKeyAction", "ACTIONS", "PAD", "pollPad", "startRun", "btn", "tag", "setInput", "keyify", "skinLook", "voxMeshData", "vgrid", "rigSpec", "rigTemplate", "rigPose", "rigAnimate", "makeActor", "setFrame", "billboard", "RIG_KIND", "ROPA", "SPRITES", "voxOn", "isRig", "actorDown", "GEAR", "ENT_LOOK", "gaitPose", "finishHD", "drawPerson", "throwFiresalt", "useCamera", "placeBeacon", "startExtraction", "updateExtraction", "wearWeapon", "EQUIP_IDS", "megNueva", "megEvent", "megEnterLevel", "megCobrar", "megAceptar", "megEntregar", "megOfertas", "MEG_TIPOS", "MEG_TIENDA", "MEG_BASES", "megCercanos", "megTexto", "megComprar", "megPick", "megPlaceObj", "buildMegBoard", "GESTOS", "hacerGesto", "mostrarGesto", "updateGestos", "vozDistancia", "vozModo", "VOZ", "vozHablar", "mpVigilar", "mpSoltar", "mpAtarConexion", "MP_VACIA_MAX", "SKIN_BY", "ACH_BY_ID", "descendTo", "nearestFocus", "interact", "spawnDrop", "removeItem", "invFind", "useOrHold",
  "BP", "bpEntries", "bpDo", "bpNav", "bpMain", "bpKey", "bpKeyAction", "renderBackpack", "toggleBackpack", "closeBackpack", "takeOut",
  "get bpOpen(){ return bpOpen; }"
].join(", ");
